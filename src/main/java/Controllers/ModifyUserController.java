...
public class ModifyUserController implements Initializable,InitializableController {
   ...
   @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        Type.getItems().add("[\"ROLE_CLIENT\"]");
       Type.getItems().add("[\"ROLE_INSTRUCTOR\"]");
       Type.getItems().add("[\"ROLE_ADMIN\"]");
       Type.getItems().add("[\"ROLE_VET\"]");
        loadData();
...
// Vérifier si le mot de passe et sa confirmation correspondent et afficher une erreur si ce n'est pas le cas
    ...
    void ModifiyUser(ActionEvent event) {
            ...
            String type = Type.getSelectionModel().getSelectedItem().toString(); // Get the selected item from ComboBox
