...
public class modifyActivityPopup implements Initializable {
    ...
    private void loadData() {
        try {
            ...
            if (activity != null) {
                ...
                Type.setValue(ActivityType.valueOf(activity.getTypeActivity().toString()));
    ...
    void ModifyActivity(ActionEvent event) {
        try {
            ...
            // Update the activity
            Activity updatedActivity = new Activity(this.activityId, utilDate, type.toString(), title, description, price, imageData);
