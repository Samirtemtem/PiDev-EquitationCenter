...
public class UsersCrudController implements Initializable {
    ...
    public void updateUserList() {
        try {
            List<Users> users = serviceUser.ReadAll();
    ...
    private void initializeTableColumns() {
        ...
        TableColumn<Users, Void> imageColumn = new TableColumn<>("Image");
        imageColumn.setCellFactory(getImageCellFactory());
        TableColumn<Users, Void> RoleColumn = new TableColumn<>("Role");
        RoleColumn.setCellValueFactory(new PropertyValueFactory<>("Role"));
        TableColumn<Users, String> prenomColumn = new TableColumn<>("Prenom");
        prenomColumn.setCellValueFactory(new PropertyValueFactory<>("lastName"));
        TableColumn<Users, String> nomColumn = new TableColumn<>("Nom");
        ...
        TableColumn<Users, String> Num_telColumn = new TableColumn<>("Num_tel");
        Num_telColumn.setCellValueFactory(new PropertyValueFactory<>("Num_tel"));
        TableColumn<Users, String> dateJoinedColumn = new TableColumn<>("dateJoined");
    ...
    private Callback<TableColumn<Users, Void>, TableCell<Users, Void>> getImageCellFactory() {
        return new Callback<TableColumn<Users, Void>, TableCell<Users, Void>>() {
            @Override
    ...
    private Callback<TableColumn<Users, Void>, TableCell<Users, Void>> getButtonCellFactory() {
        return new Callback<TableColumn<Users, Void>, TableCell<Users, Void>>() {
            @Override
