...
public class AddUserController implements Initializable {
  ...
  @Override
   // public void initialize(URL url, ResourceBundle resourceBundle) {
      //  ObservableList<Users.Roles> roles = FXCollections.observableArrayList(Users.Roles.values());
      //  Type.setItems(roles);
    ...
    void AddUser(ActionEvent event) {
      ...
      String type = Type.getValue();
        ...
        try {
            ...
            user.setName(nom);
            //user.setRoles(Users.Roles.valueOf(type.toString()));
          user.setRoles(type);
            ...
            showSuccessMessage("Nouveau user ajouté avec succées");
            returnTo(event);
