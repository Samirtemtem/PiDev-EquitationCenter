...
public class AddUserController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ObservableList<Role> role = FXCollections.observableArrayList(Role.values());
...
// Vérifier si le mot de passe et sa confirmation correspondent et afficher une erreur si ce n'est pas le cas
    ...
    void AddUser(ActionEvent event) {
        ...
        String type = Type.getSelectionModel().getSelectedItem(); // Get the selected item from ComboBox
